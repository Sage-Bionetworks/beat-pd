...
tmp<-rbind(data.frame(Phenotype="On/Off", Model="CART", on_off_results_mse_mae, stringsAsFactors = F),
...
write.csv(tmp, "Analyses/CISPD_CART_model_scores_total_and_byLabel.csv", row.names = F, quote=F)

tmp<-rbind(data.frame(Phenotype="On/Off", Model="ENET", on_off_enet_results_mse_mae, stringsAsFactors = F),
...
write.csv(tmp, "Analyses/CISPD_ENET_model_scores_total_and_byLabel.csv", row.names = F, quote=F)
